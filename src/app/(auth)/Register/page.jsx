...
const Register = () => {
  ...
  const handlereg = async (data) => {
    ...
    if (res) {
      ...
      // 3. Redirect to the login page after a successful signup
      router.push("/Login"); 
    }
  };
  ...
  const handlegoogle = async () => {
    const data = await authClient.signIn.social({
      provider: "google",
      callbackURL: "/", // Usually you want to go to the home page after social login
    });
  };
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden ">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://static.vecteezy.com/system/resources/thumbnails/002/266/590/small/summer-beach-background-free-vector.jpg')",
        }}
      ></div>
      ...
      <div className="relative z-10 w-full max-w-md bg-transparent backdrop-blur-md border border-gray-200 shadow-xl rounded-2xl p-8">
        ...
        <div className="relative flex items-center py-2">
          ...
          <span className="shrink mx-4 text-white text-xs uppercase tracking-widest font-semibold">
            Or continue with
          </span>
          <div className="grow border-t border-white/30"></div>
        </div>
